...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "An UIPageController replacement supporting custom transitions and gestures."
  # s.description  = <<-DESC
  #                   An optional longer description of BMExtendablePageController
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Benjamin Müller" => "elchbenny@googlemail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Benjamin Müller', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  # s.source       = { :git => "https://github.com/elchbenny/BMExtPageController.git", :tag => "0.0.1" }
  s.source       = { :git => "https://github.com/elchbenny/BMExtPageController.git" }
